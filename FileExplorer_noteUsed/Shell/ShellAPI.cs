...
namespace FileExplorer.Shell
{
    ...
    public class ShellAPI
    {
        ...
        [DllImport("shell32.dll", CallingConvention = CallingConvention.StdCall,
                        BestFitMapping = true, CharSet = CharSet.Unicode)]
        ...
        static extern int SHCreateLibrary(
                [In] ref Guid IID,
                [Out] IntPtr libraryObj
                    );
        #endregion

        #region LibraryBackup.dll DllImport method
        ...
        [DllImport("LibraryBackup.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern Int32 Win7ItemBindToHandler(
            IShellItem ppsi,
        ...
        #region add method for DllImport method
        /// <summary>
        ...
        /// <summary>
        /// ItemBindToHandler for win7
        /// </summary>
        /// <param name="ppsi"></param>
        /// <param name="ShellFolder"></param>
        /// <returns></returns>
        public static Int32 ItemBindToHandler(IShellItem ppsi, out IShellFolder ShellFolder)
        {
            ShellFolder = null;
            try
            {
                ...
                if (Environment.OSVersion.Version.Major >= 6)
                {
                    return Win7ItemBindToHandler(ppsi, out ShellFolder);
                }
                return 1;
            }
            catch (Exception ex)
