...
//using Nero.Framework.SmmBasics;
using System;
...
namespace FileExplorer.ViewModel
{
    ...
    public class SearchViewModel : SortOrderViewModel, ISearch
    {
        ...
        private void SetSearchHint()
        {
            ...
            //string searchDone = ResourceProvider.LoadString("IDS_SEARCHING_DONE");
            //if (this.Items.IsNullOrEmpty())
            //{
            //    NotFoundHint = searchDone + " " + ResourceProvider.LoadString("IDS_SEARCHING_NOITEMS");
            //}
            //else
            //{
            //    NotFoundHint = searchDone + " " + ResourceProvider.LoadString("IDS_SEARCHING_SELECTITEMS");
            //}
        }
        ...
        public void InitialSearch(IFolder currentFolder)
        {
            ...
            {
                //Eric: temp ignore
                //if (currentFolder is CloudFolder)
                //{
                //    ///Cloud folder start from the root folder
                //    ///and only search the loaded items
...
//                    else
        ...
        //private void SearchCloudFolder(CloudFolder searchFolder)
        //{
        //    if (searchFolder.IsNull() || regPattern.IsNullOrEmpty())
        //    {
        //        return;
        ...
        //    ///Cloud folder only search the cached data
        //    SearchCloudCallback(searchFolder, searchFolder.Items, regPattern);
        //}

        //private void SearchCloudCallback(CloudFolder searchFolder, IEnumerable<IFile> subItems, string regPattern)
        //{
        //    if (subItems.IsNullOrEmpty() || this.IsCanceled)
        //    {
        //        lock (lockObj)
        ...
        //    {
        //        ///try exception for list cleared by other thread
        //        foreach (var item in subItems.Where(item => item.IsFolder && !(item as CloudFolder).Items.IsNullOrEmpty()))
        //        {
        //            CloudFolder folder = item as CloudFolder;
        //            SearchCloudFolder(folder);
        //        }
        //    }
        //    catch (InvalidOperationException)
        //    {
        ...
        readonly IList<string> defaultMusicExtension = new List<string>(StandardFileExtensions.GetAudioExtensions());
        readonly IList<string> defaultVideoExtension = new List<string>(StandardFileExtensions.GetVideoExtensions());
        readonly IList<string> defaultPhotoExtension = new List<string>(StandardFileExtensions.GetImageExtensions());
