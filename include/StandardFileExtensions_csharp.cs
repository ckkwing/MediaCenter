...
//
//    If you want to change the list of file extensions, edit StandardFileExtensions.xml instead
//    If you want to change the resulting code, edit the text template instead
//
...
namespace Nero.Framework.SmmBasics
{
    /// <summary> Provides the list of file extensions that are indexed and can be displayed by the 
    /// Nero SMM applications.  Attention: The lists are not automatically synced with SMC/PTT. </summary>
